...
Gcluster.pl -dir tbl_file_directory -gene interested_gene_file [options]

FOR EXAMPLE: 
perl /home/xiangyang/Desktop/AMRG_TT.v-1.02/heatmap.pl -dir /home/xiangyang/Desktop/AMRG_TT.v-1.02/Final_workplace/result_statistics/tbl_heatmap_gene -scale 10 -label T -dis 8 -w 4 -l 0 -cf /home/xiangyang/Desktop/AMRG_TT.v-1.02/Final_workplace/result_statistics/Statistics_OUT/classification_gene -tree /Users/zilinyang/Desktop/AMRG_TT.v-1.02/SNP_Core_Tool/CoreSNP_workplace/phylip_file_fastme_tree.nwk -bootstrap T 
...
#create a SVG format image 
    ...
    SVG_heatmap::create_image_SVG($home_directory, $tbl_file_directory, $strain_reorder_file, $phylogenetic_file, $show_tree_topology, $workplace, \%options);
