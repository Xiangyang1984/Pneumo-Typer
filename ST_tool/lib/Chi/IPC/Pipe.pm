package Chi::IPC::Pipe;
use strict;
use warnings;

use Chi::Link::IPC::Pipe::Proc;
use Chi::Link::IPC::Pipe::Parent;

use base 'Child';

sub child_class  { 'Chi::Link::IPC::Pipe::Proc'   }
sub parent_class { 'Chi::Link::IPC::Pipe::Parent' }
